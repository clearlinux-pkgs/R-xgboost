...
Version  : 1.7.11.1
Release  : 24
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/xgboost_1.7.11.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/xgboost_1.7.11.1.tar.gz
...
%setup -q -n xgboost
pushd ..
cp -a xgboost buildavx2
popd
pushd ..
cp -a xgboost buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747412372
...
/usr/lib64/R/library/xgboost/tests/testthat/test_unicode.R
/usr/lib64/R/library/xgboost/tests/testthat/test_update.R

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/xgboost/libs/xgboost.so
/V4/usr/lib64/R/library/xgboost/libs/xgboost.so
